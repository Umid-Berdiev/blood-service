...
import DrugProductionFormModal from '/@src/components/modals/DrugProductionFormModal.vue'
...
viewWrapper.setPageTitle(t('Quality-control'))
useHead({
      ...
      <div class="column is-narrow">
        <VBreadcrumb
          ...
          :items="[
            ...
            {
              label: $t('Received_components_list'),
            },
          ]"
        />
      </div>
